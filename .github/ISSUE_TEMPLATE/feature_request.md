...
description: Suggest an idea for DristiGuide
title: "[FEATURE]: "
...
body:
  - type: markdown
    attributes:
      value: |
        Thanks for suggesting a new feature for DristiGuide! Please provide as much detail as possible.
  ...
  - type: input
    ...
    attributes:
      ...
      placeholder: "harsh01yadav08@gmail.com"
    validations:
      required: false
