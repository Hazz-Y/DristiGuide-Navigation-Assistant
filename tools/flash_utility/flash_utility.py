...
# DristiGuide Auto-Flash Script
# Generated by flash_utility.py

echo "=== DristiGuide Auto-Flash ==="
...
"""
        ...
        with open('flash_DristiGuide-Navigation-Assistant.sh', 'w') as f:
            f.write(script_content)
        os.chmod('flash_DristiGuide-Navigation-Assistant.sh', 0o755)
        ...
        with open('flash_DristiGuide-Navigation-Assistant.bat', 'w') as f:
            f.write(windows_script)
        
        print("Flash scripts created:")
        print("  Linux/Mac: flash_DristiGuide-Navigation-Assistant.sh")
        print("  Windows: flash_DristiGuide-Navigation-Assistant.bat")
...
def main():
    parser = argparse.ArgumentParser(description='DristiGuide Flash Utility')
